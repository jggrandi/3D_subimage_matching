...
void LogData::handleLog(char *l_fileName, vector<sliceRank> l_similarityResults, double l_runtime)
{
	fileName = l_fileName;
...
bool LogData::saveDataIntoFile(char *l_fileName, vector<sliceRank> l_similarityResults, double l_runtime)
{
