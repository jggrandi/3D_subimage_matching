...
$(PROG): $(SRC)
	 $(CC) $(CFLAGS) $(CDEBUG) $(WARNINGOFF) --std=c++11 $(I_ARRAY) $(I_HANDLE3DDATASETS) $(I_QUALITYASSESSMENT) $(L_ARRAY) $(L_HANDLE3DDATASETS) $(L_QUALITYASSESSMENT)  -o $(PROG) $(SRC) $(OPENMP) $(OPENGL) $(OPENCV) 
